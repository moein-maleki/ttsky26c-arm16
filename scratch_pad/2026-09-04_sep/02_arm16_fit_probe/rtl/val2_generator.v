...
module val2_generator(
    input signed    [15:0]  val_rm,
    input           [11:0]  instr_shifter_opperand,
    input                   instr_is_memory_access,
    input                   instr_is_immediate,
    
    output signed   [15:0]  val2
);

    wire        [15:0]  _32bit_immediate;
    wire        [63:0]  _32bit_immediate_rail;
    wire        [63:0]  _32bit_immediate_rail_shifted;
    wire        [15:0]  _32bit_immediate_base;

    wire        [15:0]  shift_immediate;
    wire        [63:0]  shift_immediate_rotate_rail;
    wire        [63:0]  shift_immediate_rotate_rail_shifted;
    wire        [15:0]  shift_immediate_rotate;
    wire        [15:0]  shift_immediate_lsl;
    wire        [15:0]  shift_immediate_lsr;
    wire        [15:0]  shift_immediate_asr;

    wire        [15:0]  arithmatic_immediate;
    wire        [15:0]  load_store_immediate;
    ...
    assign arithmatic_immediate     =
        ...
        (~instr_is_immediate)       ? (shift_immediate) : (16'bx);
    ...
    assign _32bit_immediate         = _32bit_immediate_rail_shifted[15:0];
    ...
    assign shift_immediate_rotate   = shift_immediate_rotate_rail_shifted[15:0];
