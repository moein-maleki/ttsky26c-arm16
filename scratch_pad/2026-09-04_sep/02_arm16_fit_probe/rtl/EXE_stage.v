module EXE_stage(
    ...
    output              mem_r_en_out,
    output              mem_w_en_out,
    output      [15:0]  branch_address_out,
    output              branch_taken_out,
    output      [15:0]  alu_result_out,
    output      [15:0]  val_rm_out,
    ...
    assign val_rm_out               =
        ...
        (frwd_sel_wb_src2_in)          ? (frwd_wb_value_in) : 16'b0;
    ...
    assign alu_in_1                 =
        ...
        (frwd_sel_wb_src1_in)          ? (frwd_wb_value_in) : 16'b0;
