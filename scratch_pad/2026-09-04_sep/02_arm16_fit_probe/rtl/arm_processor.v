module arm_processor(
    ...
    // if stage wires
    wire                if_in_freeze;
    wire        [15:0]  if_out_pc_plus_four;
    wire        [31:0]  if_out_instruction;
    
    // id stage wires
    wire        [31:0]  id_in_instruction;
    wire        [15:0]  id_in_pc_plus_four;
    wire                id_out_wb_en;
    ...
    wire        [15:0]  id_out_pc_plus_four;
    wire        [15:0]  id_out_branch_immediate;
    ...
    wire        [15:0]  id_out_val_rn;
    wire        [15:0]  id_out_val_rm;
    ...
    wire        [15:0]  exe_in_pc_plus_four;
    wire        [15:0]  exe_in_branch_immediate;
    wire        [15:0]  exe_in_val_rn;
    wire        [15:0]  exe_in_val_rm;
    ...
    wire        [15:0]  exe_out_branch_address;
    wire                exe_out_do_update_sr;
    wire                exe_out_branch_taken;
    wire        [15:0]  exe_out_alu_result;
    wire        [15:0]  exe_out_val_rm;

    // mem stage wires
    wire                mem_in_wb_en;
    wire                mem_in_mem_r_en;
    wire                mem_in_mem_w_en;
    wire        [15:0]  mem_in_alu_result;
    wire        [3:0]   mem_in_wb_reg_dest;  
    wire        [15:0]  mem_in_val_rm;
    wire                mem_out_stage_busy;
    wire                mem_out_wb_en;
    wire                mem_out_mem_r_en;
    wire        [15:0]  mem_out_alu_result;
    wire        [15:0]  mem_out_data_memory_result;
    wire        [3:0]   mem_out_wb_reg_dest;
    wire        [15:0]  mem_out_frwd_value;
    
    // wb stage wires
    wire                wb_in_wb_en;
    wire                wb_in_mem_r_en;
    wire        [15:0]  wb_in_alu_result;
    wire        [15:0]  wb_in_data_memory_result;
    wire        [3:0]   wb_in_wb_reg_dest;
    wire        [15:0]  wb_out_wb_value;
    wire                wb_out_wb_en;
